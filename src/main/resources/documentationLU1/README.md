...
Om deze file te kunnen in

<h5>IAn1: Een infrastructuur analyseren volgens een standaardmethode en op basis van gegeven functionele eisen.</h5>

Wij hebben gebruikt gemaakt van Visual Paradigm om use cases te beschrijven en dit uit te werken tot functionele eenheden. Als de LU1files.zip file wordt uitgepakt kan de lezer dit openen in een local browser
  Op deze manier komt de lezer in een (interactieve) omgeving waarin alle diagrammen te zien zijn die voor het ontwerp gemaakt zijn. Niet alle diagrammen zijn in het eindproduct verwerkt omdat 
...
<p>Het ontwerp voor de realisatie van software opgesteld op basis van gegeven specificaties. Hierbij hebben we zoveel mogelijk standaard modelleertechnieken gebruikt.
